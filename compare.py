...
s1 = "It is warm. It is summer. It is exceptional weather. So it is time for a BBQ"
s2 = "It is not warm. It is winter. It is bad weather. Absolutely no time for a BBQ"
print(s1)
print(s2)
print()
